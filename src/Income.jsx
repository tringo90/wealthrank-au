      ...
      <div style={{maxWidth:580,margin:"0 auto",padding:"32px 24px 0"}}>
        ...
        {result && (
          <div ref={resultRef}>
            ...
            <div style={{textAlign:"center",fontSize:9,color:"rgba(240,237,230,0.16)",margin:"20px 0 32px",letterSpacing:"0.05em"}}>DATA: ATO · FOR INFORMATIONAL USE ONLY · NOT FINANCIAL ADVICE</div>
          </div>
        )}
      </div>
