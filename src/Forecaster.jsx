...
function ForecastFooter({setPage}){
  ...
  return(<footer style={{borderTop:"1px solid rgba(240,237,230,0.06)",marginTop:64,padding:"44px 24px 28px",background:"#0a1628"}}>
    <div style={{maxWidth:780,margin:"0 auto"}}>
      <div style={{display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr",gap:28,marginBottom:36}}>
        ...
        <div><div style={th}>Tools</div>{[{l:"Net Worth Calculator",p:"calculator"},{l:"Income Calculator",p:"income"},{l:"Wealth Forecaster",p:"forecast"},{l:"By Generation",p:"gen"},{l:"Insights",p:"insights"}].map(i=><button key={i.l} style={lnk} onClick={()=>setPage(i.p)}>{i.l}</button>)}</div>
      ...
      <div style={{borderTop:"1px solid rgba(240,237,230,0.05)",paddingTop:16,display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          <div style={{fontSize:10,color:"rgba(240,237,230,0.18)"}}>Data: ABS 2021–22 · ASFA 2023–24 · APRA</div>
...
export default function Forecaster({ setPage }) {
  ...
  return (
    ...
    <ForecastFooter setPage={setPage}/>
  );
}
